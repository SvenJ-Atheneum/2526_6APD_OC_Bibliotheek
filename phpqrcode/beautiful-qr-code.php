...
require __DIR__.'/qrlib.php';

function generateBeautifulQRCode($text, $backgroundColor, $primaryColor, $secondaryColor, $scale, $file)
{
    $qr = QRcode::text($text);
    ...
    $count = count($qr);
    $canvasSize = 500;
    $circleSize = floor($canvasSize / ($count + 5));
